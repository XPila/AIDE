...
public class ShortRoundBuffer
{
	protected short[] mArray = null;
	protected int mCapacity = 0;
	protected int mPosition = 0;
	protected int mAvailable = 0;
	public ShortRoundBuffer(short[] array)
	{
		mArray = array;
	...
	public ShortRoundBuffer position(int newPosition)
	{
	...
	public ShortRoundBuffer available(int newAvailable)
	{
		mAvailable = newAvailable;
		return this;
	}
	public ShortRoundBuffer put(short val) 
	{
	...
	public ShortRoundBuffer put(int pos, short val)
	{
		mArray[pos] = val;
		return this;
	}
	public ShortRoundBuffer put(short[] src)
	{
		return put(src, 0, src.length);
	}
	public ShortRoundBuffer put(short[] src, int srcOffset, int count)
	{
	...
	public ShortRoundBuffer get(short[] dst)
	{
		return get(dst, 0, dst.length);
	}
	public ShortRoundBuffer get(short[] dst, int dstOffset, int count)
	{
