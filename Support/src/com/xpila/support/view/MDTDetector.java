...
public class MDTDetector
implements View.OnTouchListener
{
	public interface IMDTListener
	{
	...
	private IMDTListener mListener = null;
	private int mMask = 0;
	...
	public MDTDetector(IMDTListener listener, View v, int mask, float marginIn, float marginOut)
	{
		mListener = listener;
		mMask = mask;
		mMarginIn = marginIn;
